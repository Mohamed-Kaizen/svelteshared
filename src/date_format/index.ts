...
const REGEX_FORMAT =
	/* #__PURE__ */ /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g
...
export const normalize_date = (date: DateLike) => {
...
export function date_format(
	...
	return format_date(normalize_date(date), formatStr, options?.locales)
}

export type DateFormatReturn = ReturnType<typeof date_format>

// alias
export { date_format as dateFormat }
